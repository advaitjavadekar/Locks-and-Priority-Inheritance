...
/* in file spinlock.c */
extern void sl_init(struct sl_lock_t *);
extern void sl_lock(struct sl_lock_t *);
extern void sl_unlock(struct sl_lock_t *);
/* in file lock.c */
extern void bwf_init(struct bwf_lock_t *);
extern void bwf_lock(struct bwf_lock_t *);
extern void bwf_unlock(struct bwf_lock_t *);    
/* in file active_lock */
extern void al_init(struct al_lock_t *);
extern void al_lock(struct al_lock_t *);
extern void al_unlock(struct al_lock_t *);
extern bool8 al_trylock(struct al_lock_t *);
/* in file pi_lock */
extern void pi_init(struct pi_lock_t *);
extern void pi_lock(struct pi_lock_t *);
extern void pi_unlock(struct pi_lock_t *); 
